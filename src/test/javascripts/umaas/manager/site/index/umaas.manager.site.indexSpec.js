describe("umaas.manager.site.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('umaas.manager.site.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/umaas/manager/site/index/index.html', '');
    }));
